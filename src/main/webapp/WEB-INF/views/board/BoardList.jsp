...
<body>
	...
	<table class="boardTable">
		...
		<c:if test="${empty list }">
			<tr>
				<td colspan="5" align="center">존재하는 게시물이 없습니다.</td>
			</tr>
		</c:if>
		<c:if test="${!empty list }">
			<c:forEach var="vo" items="${list }">
				<tr>
					...
					<td><a href="boardContent.do?no=${vo.no }&page=${page }">${vo.title }</a></td>
		...
		<tr>
			<td colspan="5" align="right" style="border-bottom: none;">
				<input type="button" id="writeBtn" value="글쓰기" onclick="location.href='boardWriteForm.do?page=${page }';">
			</td>
		</tr>
	</table>
