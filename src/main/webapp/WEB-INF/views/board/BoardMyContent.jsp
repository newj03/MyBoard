			...
			<td colspan="2" align="right" style="border-bottom: none;">
				<div>
					<c:if test="${id eq vo.id }">
						<input type="button" value="수정" onclick="location.href='boardMyUpdateForm.do?no=${vo.no }&page=${page }';">
						<input type="button" value="삭제" onclick="location.href='boardMyDelete.do?no=${vo.no}';">
					</c:if>
					<input type="button" value="목록" onclick="location.href='boardMyWriting.do?page=${page }';">
				</div>
			</td>
		</tr>
	</table>
